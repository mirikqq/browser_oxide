...
mod tests {
    ...
    use crate::net::headers::{chrome_headers, chrome_headers_with_accept_ch};

    fn nav_ja4h_for(profile: &crate::stealth::StealthProfile) -> String {
        ja4h("GET", 20, &chrome_headers(profile))
    }

    #[test]
    fn ja4h_chrome_148_windows_format() {
        let s = nav_ja4h_for(&crate::stealth::presets::chrome_148_windows());
    ...
    fn ja4h_chrome_148_macos_format() {
        let s = nav_ja4h_for(&crate::stealth::presets::chrome_148_macos());
        assert!(s.starts_with("ge20nn13enus_"), "got {s}");
    }

    #[test]
    fn ja4h_chrome_148_linux_format() {
        let s = nav_ja4h_for(&crate::stealth::presets::chrome_148_linux());
        assert!(s.starts_with("ge20nn13enus_"), "got {s}");
    }

    #[test]
    fn ja4h_chrome_148_ru_uses_ruru_lang() {
        let s = nav_ja4h_for(&crate::stealth::presets::chrome_148_ru());
        assert!(s.starts_with("ge20nn13ruru_"), "got {s}");
    }

    #[test]
    fn ja4h_chrome_148_cn_uses_zhcn_lang() {
        let s = nav_ja4h_for(&crate::stealth::presets::chrome_148_cn());
    ...
    fn ja4h_hdr_hash_identical_across_profiles_for_navigation() {
        ...
        let win = nav_ja4h_for(&crate::stealth::presets::chrome_148_windows());
        let mac = nav_ja4h_for(&crate::stealth::presets::chrome_148_macos());
        let lin = nav_ja4h_for(&crate::stealth::presets::chrome_148_linux());
        let ru = nav_ja4h_for(&crate::stealth::presets::chrome_148_ru());
        let cn = nav_ja4h_for(&crate::stealth::presets::chrome_148_cn());
