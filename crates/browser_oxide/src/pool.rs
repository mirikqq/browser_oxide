...
impl PagePool {
    ...
    #[allow(
        ...
        reason = "single-threaded page pool; Arc shares the idle queue within one thread, never across threads"
    )]
    ...
    #[allow(
        ...
        reason = "std Mutex guard dropped before any await; single-threaded executor, no contention"
    )]
