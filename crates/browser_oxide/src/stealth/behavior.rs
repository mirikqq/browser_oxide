//! Behavioral entropy modeling.
//!
//! Vendors that score the *distribution shape* of human input (the
//! behavioral challenge sensors) catch Bezier-curve mouse paths and
...
pub fn mouse_trajectory_with_rng<R: Rng>(
    ...
    // exactly the statistic BeCAPTCHA-Mouse / the challenge vendor's
    // behavioral scorer integrates over. Real human pointing instead *decelerates
...
mod tests {
    ...
    fn mouse_trajectory_no_endpoint_jerk_spike() {
        ...
        // exactly what BeCAPTCHA-Mouse / the challenge vendor's behavioral
        // scorer integrates. A real decelerating stop has its SMALLEST
