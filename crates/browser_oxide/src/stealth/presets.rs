...
pub fn chrome_148_macos_sampled_with_rng(rng: &mut impl rand::RngExt) -> StealthProfile {
    ...
    type ChipConfig = (
        ...
        crate::stealth::gpu::GpuProfile, // matching GpuProfile
    );
...
pub fn pixel_9_pro_chrome_148() -> StealthProfile {
    StealthProfile {
        ...
        gpu_profile: crate::stealth::gpu::apple_m3_macos(), // TODO: add android_mali_g715 GPU profile
    }
}
...
pub fn iphone_15_pro_safari_18() -> StealthProfile {
    StealthProfile {
        ...
        gpu_profile: crate::stealth::gpu::apple_m3_macos(), // TODO: ios_apple_a17_pro GPU profile
    }
}
