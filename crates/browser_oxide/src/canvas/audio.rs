...
//! challenge vendor's v3 sensor VM:
//!
...
impl AudioFingerprint {
    ...
    pub fn from_params(seed: u64, params: AudioParams) -> Self {
        ...
        // covers FingerprintJS / the challenge vendors' probes.
...
impl DynamicsCompressorKernel {
    ...
    // needless_range_loop: the channel loops index parallel
    // source/destination channel buffers by the same `ch`.
    #[allow(
        clippy::needless_range_loop,
        reason = "channel loops index parallel source/destination buffers"
    )]
    fn process(
        &mut self,
        source_channels: &[&[f32]],
        ...
        // FingerprintJS/CreepJS/challenge-vendor probe (threshold=-50, knee=40,
